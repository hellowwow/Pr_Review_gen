...
print("提取pull信息ing...")
pulls_map = {}
with open('E:\\pr_review\\crawl_json\\pulls_0714','r', encoding='utf-8') as read_file:
...
print("提取commit信息ing..")
commit_map = {}
with open('E:\\pr_review\\crawl_json\\pull_commit_0715','r', encoding='utf-8') as read_file:
    for line in read_file:
        list = json.loads(line.strip())
...
cnt2 = 0
data_list = []
with open('E:\\pr_review\\crawl_json\\pull_commit_code_comment_0708','r', encoding='utf-8') as read_file, open('E:\\pr_review\\data\\commit_code_comment_0724', 'wb') as write_file:
    for line in read_file:
        # print(line)
        list = json.loads(line.strip())
